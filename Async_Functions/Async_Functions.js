...
async function loadPredefinedQuickProducts() {
    ...
    const response = await fetch("https://sar10686.corebridge.net/SalesModule/MyProducts/PredefinedProducts.asmx/GetPredefinedProducts", {
        ...
        "body": "{\"sEcho\":1,\"iColumns\":4,\"sColumns\":\"\",\"iDisplayStart\":0,\"iDisplayLength\":1000,\"sSearch_1\":\"\",\"sSearch_2\":\"\",\"iSortCol_0\":1,\"sSortDir_0\":\"asc\",\"pageIndex\":1,\"txSearch\":\"\",\"typeId\":\"2\",\"categoryId\":0,\"accId\":0,\"showActive\":\"true\"}",
        "method": "POST",
        "mode": "cors",
        "credentials": "include"
    });
