...
(function() {
  ...
  GM_xmlhttpRequest({method: 'GET', url: 'https://raw.githubusercontent.com/Monshi10x/TamperScript/main/UI/UI.js', onload: function(response) {let e = document.createElement('script'); e.type = 'text/javascript'; e.src = 'https://raw.githubusercontent.com/Monshi10x/TamperScript/main/UI/UI.js'; document.head.appendChild(e);}});
  ...
  GM_xmlhttpRequest({method: 'GET', url: 'https://raw.githubusercontent.com/Monshi10x/TamperScript/main/Modal/Modal.js', onload: function(response) {let e = document.createElement('script'); e.type = 'text/javascript'; e.src = 'https://raw.githubusercontent.com/Monshi10x/TamperScript/main/Modal/Modal.js'; document.head.appendChild(e);}});
