class Modal {
      ...
      constructor(headerText, callbackFunction) {
            ...
            this.#bodyContainer.style = "width:100%;min-height:50px;display:block;z-index:1002;background-color:white;margin:0px;overflow-y:auto;margin-bottom:50px;height:calc(100% - 100px)";
            this.#modalContainer.appendChild(this.#bodyContainer);

            this.#footerContainer = document.createElement('div');
            this.#footerContainer.className = 'modalContainerFooter';
            this.#footerContainer.style = "width:100%;height:50px;display:block;position:absolute;bottom:0px;";
