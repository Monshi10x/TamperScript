class Leg {
	...
	createGUI(parentObject, canvasCtx, updateFunction) {
		...
		this.l_qty = createInput_Infield("Qty", 2, "width:100px;margin-right:400px;", this.callback, this.l_legContainer);
		setFieldDisabled(true, this.l_qty[1], this.l_qty[0]);
		this.l_heightAboveGround = createInput_Infield("Height Above Ground", "2000", "width:150px;margin-right:400px;", this.callback, this.l_legContainer, true, 100);
		...
		this.l_dimensions = createDropdown_Infield("Leg Dimensions", 0, "width:150px;", null, this.callback, this.l_legContainer);
		this.createDimensionsOptions(0 /*initially set to Gal Steel, index 0*/);
		this.l_flip = createCheckbox_Infield("Flip", false, "width:100px;", this.callback, this.l_legContainer);
		this.l_hr2 = createHr("width:95%", this.l_legContainer);
		this.l_cap = createDropdown_Infield("Cap", 0, "width:150px;", [createDropdownOption("Plastic Cap", "Plastic Cap"), createDropdownOption("Weld Closed", "Weld Closed"), createDropdownOption("Gal Cap", "Gal Cap")], this.callback, this.l_legContainer);
