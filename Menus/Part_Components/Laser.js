class Laser extends SubMenu {
      ...
      static maxCutSize = {width: 1300, height: 2500};
	...
	/*overrides*/ReceiveSubscriptionData(data) {
      ...
      extractMaterialFromSubscription(data) {
            if(typeof LaserToolpathTimeLookup !== "object" || LaserToolpathTimeLookup == null) return null;
            if(!data || !data.data || !Array.isArray(data.data)) return null;
            let materialKeys = Object.keys(LaserToolpathTimeLookup);
      ...
      matchThicknessToProfiles(thicknessCandidate, materialKey) {
            let availableThicknesses = Object.keys(LaserToolpathTimeLookup[materialKey] || {});
