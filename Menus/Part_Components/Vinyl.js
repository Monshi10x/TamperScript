class Vinyl extends Material {      /*
      ...
      async Create(productNo, partIndex) {
            ...
            let sizeEntries = dataEntries.filter((entry) => !entry.finalRollSize).map((entry) => entry.QWHD);
            partIndex = await this.createDimensionParts(productNo, partIndex, partFullName, sizeEntries, {svgString: this.#f_visualiser.unscaledSVGString});
