class Size2 extends SubscriptionManager {
      ...
      constructor(parentContainer, lhsMenuWindow) {
            ...
            this.#width = createInput_Infield("Width", null, "width:150px;margin:0px 5px;box-shadow:none;box-sizing: border-box;", () => {this.UpdateFromChange();}, this.#container, true, 100);
