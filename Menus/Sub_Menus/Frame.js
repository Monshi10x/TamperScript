class Frame {
      ...
      createGUI(parentObject, canvasCtx, updateFunction) {
            ...
            this.l_powdercoatingTotalEach = createDropdown_Infield("Total or Each", 0, "width:100px;display:none;margin-right:50px;", [createDropdownOption("Total", "Total"), createDropdownOption("Each (Per Frame)", "Each")], this.callback, this.l_frameContainer);
            ...
            this.l_2PacTotalEach = createDropdown_Infield("Total or Each", 0, "width:100px;display:none;margin-left:50px;", [createDropdownOption("Total", "Total"), createDropdownOption("Each (Per Frame)", "Each")], this.callback, this.l_frameContainer);
